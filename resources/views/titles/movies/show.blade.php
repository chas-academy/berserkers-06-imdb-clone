@include('layouts.header')
    <article class="page-content">
        <div class="centered-content">
            <section class="item-header">
                <h1 class="hero-header">{{$movie->title}}</h1> <p>Add icons here for review title, add to WL and rating</p>
            </section>
            <article class="item">
    ...
    <div class="review-container">
        <div class="h1-button"><h1 class="review-header">Reviews & Comments</h1><a class="button is-primary" id="review-button" href="#hej">Review this title</a></div>
        <div class="review-content">
            ...
            <div class="create-comment">
                ...
                <div class="field is-grouped">
                    ...
                    <p class="control">
                        <button class="button is-light" id="cancel-button">
                        Cancel
                        </button>
                    </p>
                </div>
        ...
        <div class="review-content">
            ...
            <div class="create-comment">
                ...
                <div class="field is-grouped">
                    <p class="control">
                        <a class="button is-primary" id="submit-button">
                        Submit
                        </a>
                    </p>
                    <p class="control">
                        <a class="button is-light" id="cancel-button">
                        Cancel
                        </a>
                    </p>
                </div>
